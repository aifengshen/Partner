...
import com.cebbank.partner.adapter.OfficialCourseAdapter;
...
public class OfficialCourseActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_official_course);
        initView();
        setListener();
        requestFaq(true);
    }
    ...
    private void initView() {
        ...
        data = new ArrayList<>();
        mAdapter = new OfficialCourseAdapter(R.layout.activity_official_course_item, data);
...
//        mAdapter.setPreLoadNumber(3);
    ...
    private void requestFaq(final boolean isRefresh) {
        ...
        sendOkHttpRequest(this, UrlPath.Tutoriallist, jo, mSwipeRefreshLayout, new HttpCallbackListener() {
            @Override
            public void onFinish(String response) throws JSONException {
                ...
                Gson gson = new Gson();
                List<OfficialCourseBean> attentionPartnerBeanList =
                        gson.fromJson(jsonArray.toString(), new TypeToken<List<OfficialCourseBean>>() {
                        }.getType());
    ...
    private void setData(boolean isRefresh, List<OfficialCourseBean> data) {
        mNextRequestPage++;
