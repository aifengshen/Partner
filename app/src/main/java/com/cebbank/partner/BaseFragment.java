 ...
 */
public class BaseFragment extends Fragment implements AMapLocationListener,EasyPermissions.PermissionCallbacks {
    ...
    public void onResume() {
        ...
        if (hasPermission()) {
            ...
            EasyPermissions.requestPermissions(this, "定位权限很重要哦", 123,
                    Manifest.permission.ACCESS_COARSE_LOCATION,
                    Manifest.permission.ACCESS_FINE_LOCATION,
                    Manifest.permission.WRITE_EXTERNAL_STORAGE,
                    Manifest.permission.READ_EXTERNAL_STORAGE,
...
//        return EasyPermissions.hasPermissions(getActivity(), Manifest.permission.WRITE_EXTERNAL_STORAGE);
//    }
...
//                            hasStoragePermission() ? "yes" : "no"), Toast.LENGTH_SHORT).show();
